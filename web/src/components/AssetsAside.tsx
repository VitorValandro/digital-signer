...
type AssetsAsideProps = {
  currentSelectedAsset: string | undefined;
  setCurrentSelectedAsset: (current: string) => void;
...
export function AssetsAside({
  ...
  useEffect(() => {
    ...
    setCurrentSelectedAsset(firstSignature.id);
              ...
              {data.map((asset) => {
                return (
                  <AssetComponent
                    key={asset.id}
                    asset={asset}
                    selected={asset.id == currentSelectedAsset}
